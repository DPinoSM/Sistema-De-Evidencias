...
router.get('/pdf/:id', validate_token_1.default, evidencias_1.generarPDF);
router.get('/usuario/:id_usuario', validate_token_1.default, evidencias_1.getEvidenciasByUsuario);
