...
const newEvidencia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { numero_folio, fecha_evidencia, numero_de_mejoras, descripcion, resultado, almacenamiento, unidades_personas_evidencias, palabra_clave, nombre_corto_evidencia, fecha_creacion, fecha_actualizacion, id_detalle_revisor, id_detalle_dac, id_detalle_comite, id_usuario, id_debilidades, id_unidad, id_ambito_geografico, id_ambito_academico, id_registro, id_carrera, id_facultad, id_procesos, id_impacto, id_estado } = req.body;
...
const deleteEvidencia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const idUEvidencia = yield user_1.User.findOne({ where: { id_evidencia: id } });
        if (!idUEvidencia) {
            return res.status(400).json({
