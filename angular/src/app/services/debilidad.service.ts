...
export class DebilidadService {
  private baseUrl = 'http://localhost:3000/api/debilidades';

  constructor(private http: HttpClient) {}

  nuevaDebilidad(data: any): Observable<any> {
  ...
  obtenerDebilidad(): Observable<any> {
  ...
  obtenerDebilidadPorId(id: number): Observable<any> {
  ...
  eliminarDebilidad(id: number): Observable<any> {
  ...
  actualizarDebilidad(id: number, data: any): Observable<any> {
