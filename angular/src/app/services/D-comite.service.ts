...
export class ComiteService {
  private baseUrl = 'http://localhost:3000/api/comite';

  constructor(private http: HttpClient) {}

  nuevaComite(data: any): Observable<any> {
  ...
  obtenerComitePorId(id: number): Observable<any> {
  ...
  eliminarComite(id: number): Observable<any> {
  ...
  actualizarComite(id: number, data: any): Observable<any> {
